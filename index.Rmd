...
title: |
  ![](/cloud/project/proyecto2/Logo_UCO.png){width=2in}  
  "El chocolate"
...
output:
  ...
  html_document:
    toc: true
    toc_float: true
bibliography: ["/cloud/project/proyecto2/zotero.bib", "/cloud/project/proyecto2/libraries.bib"]
link-citations: true
---
...
mydata <- read.csv("/cloud/project/proyecto2/flavors_of_cacao.csv", row.names = NULL)
```
